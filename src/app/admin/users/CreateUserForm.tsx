...
export function CreateUserForm() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Force is_admin = false for regular users
    ...
    <div className="bg-white rounded-xl border border-[#cccccc] shadow-sm p-6 space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="font-semibold text-[#0d2137] flex items-center gap-2">
          <span className="material-symbols-outlined text-[#1a7a5e]">person_add</span>
          Add New User
        </h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <p className="text-xs text-[#6e7a74]">
          Account will be created without admin access and email confirmed immediately.
        </p>
